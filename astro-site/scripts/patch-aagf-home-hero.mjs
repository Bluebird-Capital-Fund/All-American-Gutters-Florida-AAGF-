...
const HERO = {
  eyebrow: 'Get your free design consultation',
  headline: 'Best Gutter Service in South Florida',
  lead: 'We install and repair seamless gutters, gutter guards, and downspouts for homes across South Florida. Free design consultation, local crews, and reliable workmanship. Open 24/7 for your call.',
