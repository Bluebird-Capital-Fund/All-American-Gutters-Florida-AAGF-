#!/usr/bin/env node
/**
 * Roof Fascia South Florida service page — slug, SEO meta, and full page copy.
 *
 * Run: cd astro-site && node scripts/patch-aagf-roof-fascia-page.mjs
 */
...
async function main() {
  exitOrSkipIfNoSanityWriteCreds(projectId, token, 'patch-aagf-roof-fascia-page')
  ...
  if (!page?._id) {
    ...
    await client.patch(page._id).set(roofFasciaSouthFloridaPage).commit()
    console.log(
  ...
  console.log(`Done. Roof fascia page is live at /${NEW_SLUG}/`)
}
