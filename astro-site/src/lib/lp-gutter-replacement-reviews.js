...
export const GUTTER_REPLACEMENT_LP_REVIEWS = [
  {
    ...
    quote:
      'Everything went great we only gave short notice and they responded very quickly. They then returned the following day to complete our gutter replacement.',
  },
  {
    ...
    quote:
      "Called All American Gutters. They answered on the second ring. Now they are the gutter replacement company we'll be using for our spec homes.",
  },
  {
    ...
    quote:
      'We use All-American Gutters exclusively for gutter replacement...due to their competitive pricing, timely work, and quality.',
  },
  {
    ...
    quote:
      'Excellent customer service on our gutter replacement! Highly recommend "All American" to get the job done.',
  },
  {
...
/**
 * Bold the first gutter-replacement related term only (black via CSS on `.testimonial strong`).
 */
