...
export const FASCIA_REPAIR_SOUTH_FLORIDA_SLUG = 'fascia-repair-south-florida'



/** @deprecated use FASCIA_REPAIR_SOUTH_FLORIDA_SLUG */

export const ROOF_FASCIA_SOUTH_FLORIDA_SLUG = FASCIA_REPAIR_SOUTH_FLORIDA_SLUG
...
export const roofFasciaSouthFloridaPage = {
  ...
  title: 'Fascia Repair South Florida',

  slug: { _type: 'slug', current: FASCIA_REPAIR_SOUTH_FLORIDA_SLUG },

  eyebrow: 'Fascia Repair',

  headline: 'Fascia Repair in South Florida',

  lead:

    'If fascia boards are soft, pulling away, or showing water damage, it usually means the roof edge has been exposed to moisture for too long. Our South Florida fascia repair service restores and protects the structural edge of your roof so it can handle heavy rain, wind, and constant humidity without breaking down.',

  heroFormIntro:

    'Schedule a free consultation and get your fascia repair assessed for South Florida moisture and storm damage.',

  meta: {

    _type: 'meta',

    title: 'Fascia repair in South Florida | Free Consultation | All American',

    description:

      'South Florida fascia repair and installation for strong, clean roof edges. Protect your home with expert service and a free consultation.',
  ...
  contentSections: [

    {
      ...
      heading: 'Common Fascia Repair Problems in South Florida',
...
<li>Soft or weakened fascia boards from long-term moisture exposure</li>
...

    {
      ...
      heading: 'Our South Florida Fascia Repair Services',
...
<p>Our fascia repair services include:</p>
...
<p>We also evaluate connected systems like <a href="/aluminum-gutters-fl/">aluminum gutters in South Florida</a> since overflow is one of the main causes of fascia deterioration. Similarly, roof edge ventilation is also reviewed alongside <a href="/soffit-repair-south-florida/">South Florida soffit repair</a> to prevent recurring moisture buildup.</p>`,
...

    {
      ...
      heading: 'Why Proper Fascia Repair Matters in South Florida',
...
<p>Once fascia starts breaking down, it can quickly affect the entire roof edge system.</p>`,
...

    {
      ...
      heading: 'Our Fascia Repair Process in South Florida',
...
<li>Clean, organized job sites after completion</li>
  ...
  faq: {
    ...
    headline: 'South Florida Fascia Repair FAQs',

    headingId: 'fascia-repair-south-florida-faq',
    ...
    items: [

      {
        ...
        question: 'How do I know if my fascia is damaged in South Florida?',
...

      {
        ...
        question: 'How often should fascia be inspected in South Florida?',
