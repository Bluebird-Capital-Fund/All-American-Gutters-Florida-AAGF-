...
export const ROOF_SOFFIT_SOUTH_FLORIDA_SLUG = 'roof-soffit-south-florida'

const MEDIA = 'Media (AAGF)/Images (AAGF)'

export const roofSoffitSouthFloridaPage = {
  title: 'Roof Soffit South Florida',
  slug: { _type: 'slug', current: ROOF_SOFFIT_SOUTH_FLORIDA_SLUG },
  eyebrow: 'Roof Soffit',
  headline: 'Roof Soffit in South Florida',
  lead:
    'If soffit panels are sagging, stained, or pulling apart, it usually means moisture or airflow issues are already affecting the roofline. Our South Florida roof soffit service restores proper ventilation and helps protect the edge of your roof from ongoing damage.',
  heroFormIntro:
    'Schedule a free consultation and get your roof soffit assessed for South Florida humidity and storm exposure.',
  meta: {
    _type: 'meta',
    title: 'Roof Soffit in South Florida | Free Consultation | All American',
    description:
      'South Florida roof soffit solutions to improve airflow and prevent damage. Reliable service with a free consultation included.',
  },
  layoutBackgrounds: {
  ...
  contentSections: [
    {
      ...
      heading: 'Common Roof Soffit Problems in South Florida',
...
<li>Blocked ventilation in older or poorly maintained systems</li>
    ...
    },
    {
      ...
      heading: 'Our South Florida Roof Soffit Services',
...
<p>Our roof soffit services include:</p>
<ul>
...
<p>We also look at the roof fascia in South Florida because soffit damage rarely happens on its own, and both usually show the same moisture and airflow stress. Additionally, we check how the <a href="/gutter-downspout-south-florida/">South Florida gutter downspout</a> is moving water away to reduce repeat buildup.</p>`,
    ...
    },
    {
      ...
      heading: 'Why Proper Roof Soffit Matters in South Florida',
...
<p>In South Florida, constant humidity and storm cycles make these issues develop faster than most expect.</p>`,
    },
    {
      ...
      heading: 'Our Roof Soffit Process in South Florida',
...
<li>A professional, service-driven approach focused on long-term, durable results</li>
  ...
  faq: {
    _type: 'faq',
    headline: 'South Florida Roof Soffit FAQs',
    headingId: 'roof-soffit-south-florida-faq',
    items: [
      {
        _type: 'faqItem',
        _key: 'aagf-soffit-faq-damaged',
        question: 'How do I know if my roof soffit is damaged in South Florida?',
        answerHtml:
